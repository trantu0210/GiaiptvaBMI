            ...
            controls=[     
                ...
                ft.Row(
                    controls=[      
                        ...
                        ActionButton(text="Aᴮ", button_clicked=self.button_clicked),
                ...
                ft.Row(
                    controls=[    
                        DigitButton(text="sinx", button_clicked=self.button_clicked),   
                        DigitButton(text="cosx", button_clicked=self.button_clicked),  
                        DigitButton(text=".", button_clicked=self.button_clicked),                            
                        ActionButton(text="=", button_clicked=self.button_clicked)
                    ]
                )                
