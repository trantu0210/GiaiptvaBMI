...
class Bac4(ft.Container):
                        ...
                        controls=[ 
                            ft.Container(
                                ...
                                content=ft.ResponsiveRow(
                                    controls=[                                                                       
                                        ft.Column(col={"xs":12}, controls=[ ft.Text("Ax⁴ + Bx³ + Cx² + Dx + E = 0", size=21, color="#FFFFFF", weight=ft.FontWeight.W_600)])                                                                                                                                              
                                    ]                                        
                                )       
                            )                                                                                                  
                        ]                                                                                          
    ...
    def calc(self,e):        
        ...
        if (choice_a != 0):   
            ...
            self.result.value = str("Pt: {0}x⁴ + {1}x³ + {2}x² + {3}x + {4} = 0".format(choice_a,choice_b,choice_c, choice_d, choice_e) + " có các nghiệm: ")
