...
class DigitButton(CalcButton):
    def __init__(self, text, button_clicked, expand=1):
        ...
        self.style = ft.ButtonStyle(
            ...
            side=ft.BorderSide(2, color=ft.colors.YELLOW),
...
class CalculatorApp2(ft.Container):    
    def __init__(self):
        super().__init__()
        self.reset()   
        self.width = 350 
        ...
        self.content = ft.Column(     
            controls=[     
                ...
                ft.Row(
                    controls=[           
                        DigitButton(text="A/B", button_clicked=self.button_clicked),  
                ...
                ft.Row(
                    controls=[                        
                        ActionButton(text="log2(x)", button_clicked=self.button_clicked),                       
                        ActionButton(text="logb(x)", button_clicked=self.button_clicked), 
                        ActionButton(text=">A/B", button_clicked=self.button_clicked)                                      
                    ]
                )            
            ]
        )
    ...
    def button_clicked(self, e):
        ...
        if self.result.value == "Error" or data == "AC":
        ...
        elif data in ("+", "一", "X", "/", "A/B","log2(x)", "logb(x)", "1/x"):
            ...
            self.result.value = Fraction(Decimal(self.result.value))                
        self.update()   
    ...
    def calculate(self, operand1, operand2, operator):
        if operator == "+": 
           ...
           return self.format_number(operand1 * operand2)    
            ...
            return Fraction(int(operand1),int(operand2))   
        if operator == "1/x": 
            return self.format_number(1 / operand1) 
        elif operator == "log2(x)":
            if operand1 == 0:
                return "-Infinity"
            elif operand1 < 0:
                return "Error"
            else:
                return self.format_number(math.log2(float(operand1)))    
        elif operator == "logb(x)":
            if operand2 == 0:
                return "Undefined"
            elif operand2 < 0:
                return "Error"
                ...
                return self.format_number(math.log(float(operand2), float(operand1)))                 
